...
import styles from "@/styles/client/appointment-future/AppointmentFuture.module.css";
  ...
  return (
    <>
     <ToastContainer
      ...
      />
      <Head>
        <title>Appointment-future | Psychix</title>
        <meta name="description" content="Appointment-future | Psychix" />
        ...
        <div className={"container-fluid p-0 "}>
          ...
          <div>
            <div className={styles.appointmentHeader}>
              <span onClick={()=> router.back(-1)} href="#"  className="cursor-pointer">
