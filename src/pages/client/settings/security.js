...
const Security = () => {
  ...
  // console.log("redtfgyhuiko",styles)
  ...
  const [logginSessionLoader, setLoginSessionLoader] = useState(false);
  const getLogginSession = async () => {
    // userToken
    setLoginSessionLoader(true);
    const items = localStorage.getItem("userTokenRefresh");
    await axiosInstance
      .get(`${API.getLogginSession}/${items}`)
      // .get(`${API.getLogginSession}`)
      .then((res) => {
        setLoginSessionLoader(false);
  ...
  return (
    <>
              ...
              <div className={styles.edititing_profile}>
                ...
                <div className={styles.security_info}>
                  ...
                  <div className={styles.updt_password}>
                    ...
                    {/* <button onClick={handleUpdatePassword} data-bs-toggle="modal" data-bs-target="#exampleModal">Update password</button> */}
                  </div>
                  <hr />
                  ...
                  <div className={styles.account_info}>
                    <div className={styles.submit_btn}>
                        ...
                        <p><img src="/images/SettingsImage/icons/cross.svg" alt="" /> Clear all</p>
                    </div>
                ...
                <div className={styles.security_info}>
                  ...
                  {logginSessionLoader ? (
                    ...
                    <div
                      className={
                        "NoDataFound font-14px d-flex mt-3 align-items-center justify-content-center"
                      }
                    >
                      No Available Data
                    </div>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <form action="" onSubmit={handleSubmit(reveiw)}>
                  ...
                  <div className="mb-4">
                    <div
                      className={`input-group  ${
                        errors.oldPassword && styles.invalid
                      } rounded`}
                    >
