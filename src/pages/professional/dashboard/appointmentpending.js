              ...
              data?.length === 0 ?
                ...
                <div className={styles.appointmentHistoryRight}>
                  <div className={styles.appointmentRS}>
                    {data?.map((ele) => {
                      console.log("qwertyuioplkj",ele)
                      return (
                        <AppointmentReason
                          key={ele?.id}
                          first_name={ele?.professional?.first_name}
                          last_name={ele?.professional?.last_name}
                          reason={ele?.reason}
                          time={`${ele?.duration / 60}`}
                          hourlyRate={ele?.professional?.actual_rate}
                          paid={ele?.professional?.actual_rate * `${ele?.duration / 60}`}
                          timming={ele?.start_time}
