...
import GoogleCalander from "@/components/googleHandlers/googleCalander";
...
const Profile = () => {
  ...
  const [isGoogleCalander, setIsGoogleCalander] = useState(false);
  ...
  useEffect(() => {
    if (id) {
      ...
      if (userProfileData) {
        ...
        setIsGoogleCalander(JsonValue?.g_calendar_setup);
  ...
  const onSuccessHandler = () => {
    localStorage.setItem(
      "userInfo",
      JSON.stringify({ ...userProfile, g_calendar_setup: isGoogleCalander })
    );
    setIsGoogleCalander(!isGoogleCalander);
  };
            ...
            >
              <div className={styles.user_sidebar}>
                ...
                <div className="d-flex justify-content-center">
                  <GoogleCalander
                    isGoogleCalander={isGoogleCalander}
