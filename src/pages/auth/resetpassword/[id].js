...
import { resetpasswordCall } from "@/store/client/resetpassword";
            ...
            <div className={classNames(styles.leftDiv, "col-sm-6 p-0")}>
              <div className={classNames(styles.formWrapper, "w-100")}>
                <div className={styles.formDiv + " h-100"}>
                  ...
                  <form className={`${classNames(styles.formtag)} mt-5`}>
                    <>
                      <div className="row">
                        <div className="col">
                          <div className="mb-4">
                              ...
                              trigger()
                                .then((res) => {
                                  if (res) {
                                    ...
                                    dispatch(
                                      resetpasswordCall({
                                        body: { password: fieldData.password },
                                        id: id,
                                      })
                                    ).then((res) => {
                                      if (!res.error) {
                                        if (
                                          res.payload.role === "professional"
                                        ) {
                                          router.push("/professional/login");
                                        } else if (
                                          res.payload.role === "client"
                                        ) {
                    ...
                    <div className={styles.copyright}>
                      © 2023 Profesy. All rights reserved.
                    </div>
                  </form>
                </div>
              </div>
